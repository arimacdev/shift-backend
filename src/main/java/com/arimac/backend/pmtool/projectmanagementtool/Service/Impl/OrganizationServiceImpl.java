...
public class OrganizationServiceImpl implements OrganizationService {
    ...
    @Override
    public Object getAllOrganizations(String userId, int startIndex, int endIndex, boolean allRecords) {
        ...
        if (user == null)
            return new ErrorMessage(ResponseMessage.USER_NOT_FOUND, HttpStatus.NOT_FOUND);
        return new Response(ResponseMessage.SUCCESS, HttpStatus.OK, organizationRepository.getAllOrganizations(limit, startIndex, allRecords));
    }

    @Override
    public Object getOrganizationById(String userId, String organizationId) {
        User user = userRepository.getUserByUserId(userId);
        if (user == null)
            return new ErrorMessage(ResponseMessage.USER_NOT_FOUND, HttpStatus.NOT_FOUND);
        return new Response(ResponseMessage.SUCCESS, HttpStatus.OK, organizationRepository.getOrganizationById(organizationId));
    }
    ...
    @Override
    public Object flagOrganization(String userId, String organizationId) {
        User user = userRepository.getUserByUserId(userId);
        if (user == null)
            return new ErrorMessage(ResponseMessage.USER_NOT_FOUND, HttpStatus.NOT_FOUND);
        Organization organization = organizationRepository.getOrganizationById(organizationId);
        ...
        organizationRepository.flagOrganization(organizationId);
        return new Response(ResponseMessage.SUCCESS, HttpStatus.OK);
    }
}
