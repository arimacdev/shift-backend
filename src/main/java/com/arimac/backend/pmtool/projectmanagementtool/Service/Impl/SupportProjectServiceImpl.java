...
public class SupportProjectServiceImpl implements SupportProjectService {
    ...
    public SupportProjectServiceImpl(UserRepository userRepository,  OrganizationRepository organizationRepository, InternalSupportService internalSupportService) {
