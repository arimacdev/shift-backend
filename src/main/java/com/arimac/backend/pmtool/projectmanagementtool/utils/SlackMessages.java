...
public class SlackMessages {
    ...
    public static  final String TASK_ASSIGNMENT_TRANSITION_GREETING =":wave: Hey There! following Task Assignment has been modified and has been assigned to you";
